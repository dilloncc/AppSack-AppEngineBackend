...
package com.appsack.model.appideachangelogendpoint;
...
public class Appideachangelogendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetAppIdeaChangeLog extends AppideachangelogendpointRequest<com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog> {
    ...
    protected GetAppIdeaChangeLog(java.lang.Long id) {
      super(Appideachangelogendpoint.this, "GET", REST_PATH, null, com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog.class);
   ...
   *
   * @param content the {@link com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog}
   * @return the request
   */
  public InsertAppIdeaChangeLog insertAppIdeaChangeLog(com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog content) throws java.io.IOException {
    InsertAppIdeaChangeLog result = new InsertAppIdeaChangeLog(content);
    initialize(result);
    return result;
  }

  public class InsertAppIdeaChangeLog extends AppideachangelogendpointRequest<com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog> {
     ...
     * @since 1.13
     */
    protected InsertAppIdeaChangeLog(com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog content) {
      super(Appideachangelogendpoint.this, "POST", REST_PATH, content, com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog.class);
    }
  ...
  public class ListAppIdeaChangeLog extends AppideachangelogendpointRequest<com.appsack.model.appideachangelogendpoint.model.CollectionResponseAppIdeaChangeLog> {
    ...
    protected ListAppIdeaChangeLog() {
      super(Appideachangelogendpoint.this, "GET", REST_PATH, null, com.appsack.model.appideachangelogendpoint.model.CollectionResponseAppIdeaChangeLog.class);
    }
   ...
   * @return the request
   */
  public UpdateAppIdeaChangeLog updateAppIdeaChangeLog(com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog content) throws java.io.IOException {
    UpdateAppIdeaChangeLog result = new UpdateAppIdeaChangeLog(content);
    initialize(result);
    return result;
  }

  public class UpdateAppIdeaChangeLog extends AppideachangelogendpointRequest<com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog> {
     ...
     * @since 1.13
     */
    protected UpdateAppIdeaChangeLog(com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog content) {
      super(Appideachangelogendpoint.this, "PUT", REST_PATH, content, com.appsack.model.appideachangelogendpoint.model.AppIdeaChangeLog.class);
    }
